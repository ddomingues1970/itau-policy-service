...
class SolicitationControllerIT {
    ...
    void create_shouldReturn201AndBody() throws Exception {
        ...
        mockMvc
                .perform(post("/solicitations").contentType(MediaType.APPLICATION_JSON).content(requestJson))
    ...
    void getById_shouldReturn404_whenNotFound() throws Exception {
        ...
        mockMvc.perform(get("/solicitations/{id}", randomId))
